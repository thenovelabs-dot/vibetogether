    ...
    <div className="fixed inset-0 z-[9999] flex items-end sm:items-center justify-center">
      ...
      <div className="relative bg-white w-full sm:max-w-sm rounded-t-[24px] sm:rounded-[24px] px-6 pt-8 pb-10 shadow-xl flex flex-col items-center text-center">
        ...
        <p className="text-[14px] text-[#6a7282] mb-7 tracking-[-0.32px] leading-relaxed">
          상세 내용은 로그인 후 볼 수 있어요.<br />
          Google 계정으로 빠르게 시작해보세요.
        </p>

        <button
          onClick={handleSignIn}
          className="w-full flex items-center justify-center gap-3 py-3.5 bg-white border border-[#d1d5dc] rounded-[14px] text-[15px] font-semibold text-[#101828] hover:bg-[#f9fafb] transition-colors mb-3"
        >
